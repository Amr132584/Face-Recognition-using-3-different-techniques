...
namespace Face_Recognition
{
    public partial class Form1 : Form
    {
            ...
            if (currentFrame != null)
            {
                ...
                for (int i = 0; i < facesDetected.Length; i++)// (Rectangle face_found in facesDetected)
                {
                    ...
                    if (Eigen_Recog.IsTrained)
                    {
                        ...
                        currentFrame.Draw(name + " ", ref font, new Point(facesDetected[i].X - 2, facesDetected[i].Y - 2), new Bgr(Color.Blue));
        ...
        private void recogniserTypeToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void message_bar_Click(object sender, EventArgs e)
        {
